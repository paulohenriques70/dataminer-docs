...
1. Specify the following database settings for the Cassandra nodes:
   ...
   - **DB server**: The IP addresses or hostnames of the nodes, separated by commas. Optionally, the dafault Cassandra port 9042 can be specified (see [Configuring the IP network ports](xref:Configuring_the_IP_network_ports)). <!-- RN 34590 -->
